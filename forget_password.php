...
if($_POST['BtnSubmit']=='Submit')
{
		...
		$rs_validate = mysql_query("select * from member_master where m_emailid='$um_emailid'") or die(mysql_error());
		$total = mysql_num_rows($rs_validate);
		if ($total > 0)
		{
			$to = $um_emailid;
			$subject = "EXAM - Password";
			$passwd=mysql_result($rs_validate,0,"m_password");
			$body = "Your Login Password is [ ".$passwd." ] for EXAM System";
