...
<title>eExamination :: Show Results</title>
...
&nbsp;                          <?php
                                ...
                                $sql="select r.res_id, e.e_name, r.res_date, m_name,r.res_result from result_master r, exam_master e ,member_master m 
                                where r.res_e_id = e.e_id and m.m_id=res_mem_id and   e_id =".$_GET["id"]." order by r.res_id ";
					
					$result = mysql_query($sql);
					$count=mysql_num_rows($result);
					
				?>
			<table border="1" width="710" cellspacing="1" id="table12" style="border-collapse: collapse">
				<tr>
					<td colspan="5" class="td_tablecap"><?php echo($count); ?> 
					 Results Found&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
					...
					<td width="205" class="td_tablehead">Examination Date</td>
                                        <td width="150" class="td_tablehead">Member Name</td>
